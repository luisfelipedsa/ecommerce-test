      ...
      <section className="">
        <div className="grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <button
              ...
              className="mt-1.5 inline-block bg-pink-500 px-5 py-3 text-xs font-medium uppercase tracking-wide text-white"
            >
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto sm:py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:items-stretch">
            <div className="grid p-6 bg-gray-100 rounded place-content-center sm:p-8 bg-url">
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
          ...
          <ul className="grid grid-cols-1 gap-4 mt-8 lg:grid-cols-3">
            ...
            <li className="lg:col-span-2 lg:col-start-2 lg:row-span-2 lg:row-start-1">
              <div className="relative block group">
                <img
                  src="https://i5.walmartimages.com/seo/Outfits-For-Men-Male-Summer-Casual-Print-Zipper-Turn-Down-Collar-Blouse-Short-Sleeve-Tops-Shirt-Shorts-Outfits-White_99b1288b-b8ad-48cc-a6c9-e9d2c52171fa.15608c6472aff89680b2c87d9f8d6f93.jpeg"
                  className="object-cover w-full aspect-square"
                />
                <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
